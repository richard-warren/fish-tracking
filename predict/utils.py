...
def analyze_video(video, model, skeleton_name, batch_size=64):
	...
	model:	  	  	 deepposekit model isntance
...
def make_tracking_video(video, skeleton_name, predictions=None, fps=300):
	"""
	...
	writer = VideoWriter(video_output, reader[0].shape[1:3], 'XVID', fps)  # 'XVID' works on windows
